...
RUN Rscript -e "BiocManager::install(c('XVector', 'S4Arrays', 'SparseArray', 'GenomicRanges', 'DelayedArray', 'GenomicRanges', 'SummarizedExperiment', 'SingleCellExperiment', 'Biostrings', 'igraph', 'ggraph', 'tidygraph', 'graphlayouts', 'ggtree', 'bluster', 'DECIPHER', 'DelayedMatrixStats', 'beachmat', 'BiocSingular', 'TreeSummarizedExperiment', 'sparseMatrixStats', 'MultiAssayExperiment'), update=FALSE)"
